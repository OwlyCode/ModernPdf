...
class FontDescriptor extends ObjectType\PdfDictionary
{
    public function __construct($values = array())
    {
        parent::__construct($values);
        $this['Type'] = new ObjectType\PdfName('FontDescriptor');
    }
     ...
     *
     * @param ObjectType\PdfName $name The name to set.
     */
    public function setFontName(ObjectType\PdfName $name)
    {
        $this['FontName'] = $name;
    }
     ...
     * Times.
     *
     * @param ObjectType\PdfString $name The font family.
     */
    public function setFontFamily(ObjectType\PdfString $name)
    {
     ...
     *
     * @param ObjectType\PdfName $stretch The stretch name.
     */
    public function setFontStretch(ObjectType\PdfName $stretch)
    {
     ...
     *
     * @param ObjectType\PdfArray $bbox A 4 values PdfArray representing the bounding box.
     * @throws InvalidArgumentException If the PDfArray is not a Rectangle (4 values).
     */
    public function setFontBBox(ObjectType\PdfArray $bbox)
    {
        if (count($bbox) !== 4) {
     ...
     *
     * @param ObjectType\Stream $fontfile A font file stream.
     */
    public function setFontFile(ObjectType\PdfIndirectReference $fontfile)
    {
     ...
     *
     * @param ObjectType\PdfIndirectReference $fontfile A font file stream.
     */
    public function setFontFile2(ObjectType\PdfIndirectReference $fontfile)
    {
     ...
     * @param ObjectType\PdfIndirectReference $fontfile A font file stream.
     */
    public function setFontFile3(ObjectType\PdfIndirectReference $fontfile)
    {
     ...
     * entry.
     *
     * @param ObjectType\PdfString $charset The charset string.
     */
    public function setCharSet(ObjectType\PdfString $charset)
    {
