...
class FontDescriptor extends Object
{
    /**
    ...
    public function __construct($objectNumber, $generationNumber = 0)
    {
        ...
        $this->baseType['Type'] = new Type\PdfName('FontDescriptor');
    ...
    {
        $this->baseType['FontStretch'] = $stretch;
    }
    ...
    {
        $this->baseType['FontWeight'] = $weight;
    }
    ...
    {
        $this->baseType['ItalicAngle'] = $angle;
    }
    ...
    {
        $this->baseType['CapHeight'] = $capheight;
    }
    ...
    {
        $this->baseType['AvgWidth'] = $avgwidth;
    }
    ...
    {
        $this->baseType['MaxWidth'] = $maxwidth;
    }
    ...
    {
        $this->baseType['MissingWidth'] = $missingwidth;
    }

    /**
     * (Optional) A stream containing a Type 1 font program.
     *
     * @param Type\Stream $fontfile A font file stream.
     */
    public function setFontFile(Type\PdfIndirectReference $fontfile)
    {
        $this->baseType['FontFile'] = $fontfile;
    }

    /**
     * (Optional; PDF 1.1) A stream containing a TrueType font program.
     *
     * @param Type\PdfIndirectReference $fontfile A font file stream.
     */
    public function setFontFile2(Type\PdfIndirectReference $fontfile)
    {
        $this->baseType['FontFile2'] = $fontfile;
    }
     ...
     * @param Type\PdfIndirectReference $fontfile A font file stream.
     */
    public function setFontFile3(Type\PdfIndirectReference $fontfile)
    {
        $this->baseType['FontFile3'] = $fontfile;
    }
